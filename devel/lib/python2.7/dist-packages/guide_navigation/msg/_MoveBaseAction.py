...
"""autogenerated by genpy from guide_navigation/MoveBaseAction.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct

import guide_navigation.msg
...
class MoveBaseAction(genpy.Message):
  ...
  _type = "guide_navigation/MoveBaseAction"
...
"""
  ...
  _slot_types = ['guide_navigation/MoveBaseActionGoal','guide_navigation/MoveBaseActionResult','guide_navigation/MoveBaseActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.action_goal is None:
        self.action_goal = guide_navigation.msg.MoveBaseActionGoal()
      if self.action_result is None:
        self.action_result = guide_navigation.msg.MoveBaseActionResult()
      if self.action_feedback is None:
        self.action_feedback = guide_navigation.msg.MoveBaseActionFeedback()
    else:
      self.action_goal = guide_navigation.msg.MoveBaseActionGoal()
      self.action_result = guide_navigation.msg.MoveBaseActionResult()
      self.action_feedback = guide_navigation.msg.MoveBaseActionFeedback()
