...
"""autogenerated by genpy from guide_navigation/MoveBaseActionGoal.msg. Do not edit."""
import sys
...
class MoveBaseActionGoal(genpy.Message):
  ...
  _type = "guide_navigation/MoveBaseActionGoal"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalID','guide_navigation/MoveBaseGoal']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.goal is None:
        self.goal = guide_navigation.msg.MoveBaseGoal()
    else:
      self.header = std_msgs.msg.Header()
      self.goal_id = actionlib_msgs.msg.GoalID()
      self.goal = guide_navigation.msg.MoveBaseGoal()
