...
"""autogenerated by genpy from guide_navigation/MoveBaseActionResult.msg. Do not edit."""
import sys
...
class MoveBaseActionResult(genpy.Message):
  ...
  _type = "guide_navigation/MoveBaseActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','guide_navigation/MoveBaseResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = guide_navigation.msg.MoveBaseResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = guide_navigation.msg.MoveBaseResult()
