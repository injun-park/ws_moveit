...
(cl:defmethod cl:initialize-instance :after ((m <MoveBaseGoal>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MoveBaseGoal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name guide_navigation-msg:<MoveBaseGoal> is deprecated: use guide_navigation-msg:MoveBaseGoal instead.")))

(cl:ensure-generic-function 'target_pose-val :lambda-list '(m))
(cl:defmethod target_pose-val ((m <MoveBaseGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader guide_navigation-msg:target_pose-val is deprecated.  Use guide_navigation-msg:target_pose instead.")
  (target_pose m))
